...
namespace proj_csharp_kiminoyume.Helpers
{
    ...
    {
        public static void UpSertEntities<T>
            (AppDBContext context, ICollection<T> newEntities, ICollection<T> oldEntities, Func<T, T, bool> match)
                where T : class
        {
        ...
        public static void UpdateEntity<T>
            (AppDBContext context, T newEntity, T oldEntity) 
                where T : class
        {
        ...
        public static void AddEntity<T>
            (AppDBContext context, T newEntity, ICollection<T> oldEntities) 
                where T : class
        {
